...
* **Tier 1 (Somatic/Physical Safety):**
    ...
    * **Core Goal:** **Stability and Survival.** This is the foundation that must be addressed first.
    * **Example Action:** Deploying the **Diaphragm Check**, recognizing hunger, managing physical tension, securing a safe living space.
...
* **Tier 3 (Cognitive/Relational Insight):**
    ...
    * **Core Goal:** **Growth and Mastery.** This requires stability and resources from Tier 2.
    * **Example Action:** Analyzing complex structural concepts (e.g., Chaos vs. Scarcity), defining the **"Unassailable Stability" Signal.**
